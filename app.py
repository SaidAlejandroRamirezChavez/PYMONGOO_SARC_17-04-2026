...
class GestorTareas:
    ...
    def crear_usuario(self, nombre: str, apellido: str, email: str, contrasena: str) -> tuple[str | None, str | None]:
        """Crear un nuevo usuario
        
        Returns:
            tuple: (user_id, error_message) - user_id es None si hay error
        """
        try:
